...
define config.name = _("PA_RPG TEST")
...
define config.save_directory = "PA_RPGTEST-1619465337"


define config.keymap = dict(

game_menu = [ 'K_ESCAPE', 'joy_menu' ], 

focus_left = [],                    # Переключение между кнопками
focus_right = [],                   # Переключение между кнопками
focus_up = [],                      # Переключение между кнопками
focus_down = [],                    # Переключение между кнопками

hide_windows = [],                  # Скрыть окна, скрины

rollback = [],                      # Откат

toggle_fullscreen = [ 'K_F11' ],    # Переключение полноэкранного/оконного режимов

developer = [],                     # Режим отладки

screenshot = [ 'K_PRINT' ],         # Скриншот
