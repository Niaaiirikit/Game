...
define gui.text_font = "font1.ttf"

## Шрифт, используемый именами персонажей.
define gui.name_text_font = "font1.ttf"

## Шрифт, используемый текстом вне игры.
define gui.interface_text_font = "font1.ttf"
...
define gui.nvl_borders = Borders(0, 0, 800, 800)
...
## Местоположение, ширина и выравнивание диалогового текста.
define gui.nvl_text_xpos = 45
define gui.nvl_text_ypos = 45
define gui.nvl_text_width = 475
define gui.nvl_text_xalign = 0.0

## Местоположение, ширина и выравнивание текста nvl_thought (текст от лица
## персонажа nvl_narrator).
define gui.nvl_thought_xpos = 45
define gui.nvl_thought_ypos = 45
define gui.nvl_thought_width = 475
